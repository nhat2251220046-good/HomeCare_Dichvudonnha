      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43321916395/original/KLMoqTRg7xVpCN0tBuexD6m-EhJklID5LA.png?1652102630" alt="App Store" className="h-10"/>
          </div>
        </div>
      </div>

      <div className="bg-gray-100 text-gray-500 text-center py-4 text-sm">
        &copy 2026 Btaskee. All rights reserved.
      </div>
    </footer>
  );
}
